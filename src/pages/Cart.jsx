...
const Cart = () => {
  const { products, currency, cartItems, removeFromCart, updateQuantity } = useContext(ShopContext); // ✅ added updateQuantity
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="w-7 h-7 border rounded hover:bg-gray-100 text-lg font-medium"
                  >
                    −
                  </button>
